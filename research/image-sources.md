# Image sources — Gigi’s Long Branch

September 12 update: the source gallery now uses only the four existing owner-provided
Long Branch images. The five Unsplash placeholder tiles have been removed; no Sea Bright
food photography was substituted. Source changes await the release deployment.
...
| 2 | **The Fonz Specialty** | `fanz-tile.jpg` (owner-provided) | Owner-provided, graded |
...
2. Add more gallery tiles only when the owner supplies actual Long Branch food photos.
