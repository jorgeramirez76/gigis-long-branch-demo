...
:root{{--red:#b8202a;--red-dark:#981a23;--cream:#ffffff;--cream-dark:#f8f8f8;--ink:#222222;--ink-soft:#4b4b4b;--ink-mute:#626262;--gold:#b8202a;
...
padding:.62em 1.1em;border-radius:9px;text-decoration:none;white-space:nowrap;background:var(--red);color:#fff}}
.hero{{background:#ffffff;color:#222222;padding:36px 0 30px}}
.hero h1{{font-family:var(--disp);font-weight:400;font-size:clamp(2.2rem,8vw,3.4rem);line-height:.98;margin:.2em 0 .3em}}
.hero p{{font-size:1.06rem;color:#4b4b4b;margin:0;max-width:34em}}
main section{{padding:28px 0;border-bottom:1px solid #dedede}}
h2{{font-family:var(--disp);font-weight:400;font-size:clamp(1.6rem,5vw,2.1rem);letter-spacing:.02em;color:#222222;margin:0 0 .5em}}
table{{width:100%;border-collapse:collapse;background:#f8f8f8;border:1px solid #dedede;border-radius:12px;overflow:hidden}}
...
th,td{{padding:11px 14px;border-bottom:1px solid #dedede;text-align:left;font-weight:400}}
...
td.fee{{text-align:right;font-variant-numeric:tabular-nums;font-weight:700;color:#222222;white-space:nowrap}}
tr:last-child th,tr:last-child td{{border-bottom:none}}
.note{{font-size:.9rem;color:var(--ink-mute);margin:12px 0 0}}
details{{background:#f8f8f8;border:1px solid #dedede;border-radius:10px;padding:2px 16px;margin:10px 0}}
summary{{font-weight:700;color:#222222;cursor:pointer;padding:12px 0;list-style:none}}
summary::-webkit-details-marker{{display:none}}
summary::after{{content:"+";float:right;color:var(--gold);font-weight:700}}
details[open] summary::after{{content:"\\2013"}}
.cta{{background:#ffffff;color:#222222;text-align:center;padding:30px 20px}}
.cta h2{{color:var(--gold)}}
.cta a{{margin:6px 6px 0}}
footer{{background:#ffffff;color:#4b4b4b;font-size:.9rem;padding:26px 0 40px}}
