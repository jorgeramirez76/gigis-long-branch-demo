...
def body(page, others):
    ...
    return f"""<body>
<a href="https://gigisnystylepizza.com" style="display:block;background:var(--ink);color:rgba(255,255,255,.9);text-align:center;font-size:.7rem;font-weight:600;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;padding:6px 16px">Closer to Sea Bright? Order from our Sea Bright location &rarr;</a>
