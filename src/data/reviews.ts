...
export const RATING_SNAPSHOT = {
  // Score AND count read together, first-hand, from the Google listing for
  // "Gigi's Pizza Long Branch" on 2026-09-06: "4.3 · 128 Google reviews". This is the pair the
  // 7/29 note below asked for — Google's own count, not Restaurant Guru's.
  google: { score: 4.3, count: 128, url: "https://www.google.com/maps?q=140+Brighton+Ave,+Long+Branch,+NJ+07740" },
